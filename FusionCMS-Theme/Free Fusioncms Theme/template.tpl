{$head}
	<body>
		...
		<section id="wrapper">
			...
			<footer>
<a href="http://wow.mmotop.ru/vote/666027/" target="_blank" style="position: fixed; bottom: 0; right: 0;"><img src="http://i31.fastpic.ru/big/2011/1021/6e/e7b1c0bb7d37ceaf806aec14b363e66e.png" border="0" title="Рейтинг серверов World Of Warcraft" alt="Рейтинг серверов World Of Warcraft"></a>
				...
				<p>&copy; Grand-wow.com Copyright 2013 {$serverName}</p>
			</footer>
		</section>
	</body>
